...
export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configured in chimera.json",
  ...
  "help.tabs.introduction": "Chimera is now built around tabs.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Please report this error to the Chimera team",
  ...
  "error.chain.checkConfig": "Check your config (chimera.json) provider/model names",
  ...
  "session.review.filesChanged": "Changed {{count}}",
  ...
  "sidebar.gettingStarted.line1": "Chimera includes models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Manage WSL distros on Windows. Chimera does not install a second coding-agent CLI in WSL.",
  ...
  // chimera: brand shell, key manager, gateway connect, models table
  "chimera.wsl.noInstall": "Chimera does not install or attach a coding-agent CLI in WSL. Use the local app.",
  "chimera.wsl.distroMissingEngine": "WSL CLI attach is disabled",
  "chimera.nav.label": "{{name}} navigation",
  "chimera.nav.sessions": "Sessions",
  "chimera.nav.fileTree": "File tree",
  "chimera.nav.review": "Code review",
  "chimera.nav.terminal": "Terminal",
  "chimera.nav.settings": "Settings",
  "chimera.nav.account": "Account & keys",
  "chimera.nav.sessionOnly": "{{label}} (available in a session)",
  "chimera.command.switchKey.title": "Switch key",
  "chimera.command.switchKey.description": "Switch between relay station keys",
  "chimera.status.key": "Key {{name}}",
  "chimera.status.key.label": "Select key:",
  "chimera.status.key.tooltip": "Click to switch key (Ctrl+Shift+K)",
  "chimera.status.key.manage": "Manage keys…",
  "chimera.status.sessionCost": "Session {{cost}}",
  "chimera.status.sessionCost.tooltip": "Cumulative cost of this session",
  "chimera.status.context": "Context",
  "chimera.status.context.tooltip": "Context {{used}} / {{limit}} tokens",
  "chimera.status.gateway.tooltip": "Gateway connection",
  "chimera.status.changes": "· {{count}} changed",
  "chimera.status.changes.tooltip": "Changes in this session",
  "chimera.session.turnRail.label": "Jump to turn",
  "chimera.session.turnRail.turn": "Turn {{n}}",
  "chimera.keys.title": "Keys",
  "chimera.keys.description": "Access keys under your relay station account, switch anytime",
  "chimera.keys.add": "Add key",
  "chimera.keys.header.name": "Name",
  "chimera.keys.header.key": "Key",
  "chimera.keys.header.actions": "Actions",
  "chimera.keys.name.placeholder": "e.g. Personal key",
  "chimera.keys.key.placeholder": "sk-... / chm-...",
  "chimera.keys.save": "Save and use",
  "chimera.keys.switch": "Switch",
  "chimera.keys.delete": "Delete",
  "chimera.keys.deleteNamed": "Delete {{name}}",
  "chimera.keys.inUse": "In use",
  "chimera.keys.current": "Current",
  "chimera.keys.copy": "Copy key",
  "chimera.keys.copied": "Key copied",
  "chimera.keys.rename": "Rename",
  "chimera.keys.renameNamed": "Rename {{name}}",
  "chimera.keys.renamed": "Renamed to {{name}}",
  "chimera.keys.deleteTitle": "Delete key",
  "chimera.keys.deleteConfirm": "Delete “{{name}}”? This only removes it from this device.",
  "chimera.keys.deleteConfirmActive": "“{{name}}” is in use. Deleting it will switch to “{{next}}”.",
  "chimera.keys.deleteConfirmLast": "“{{name}}” is the only key. Deleting it will disconnect the gateway until you add another.",
  "chimera.keys.deleted": "Key deleted",
  "chimera.keys.actions": "Key actions",
  "chimera.keys.empty": "No keys yet · authorize this device or paste a key",
  "chimera.keys.disconnected": "Not connected",
  "chimera.keys.chooseMethod": "Authorize this device to fetch keys, or paste a key you already have",
  "chimera.keys.connected": "Connected",
  "chimera.keys.signedIn": "Signed in",
  "chimera.keys.notSignedIn": "Not signed in",
  "chimera.keys.signOut": "Sign out",
  "chimera.keys.signedOut": "Signed out",
  "chimera.keys.switched": "Switched to {{name}}",
  "chimera.keys.switchFailed": "Switch failed, check gateway availability",
  "chimera.keys.enterKey": "Enter a key",
  "chimera.keys.defaultName": "Key {{index}}",
  "chimera.keys.footnote": "Multiple keys per relay station · Ctrl+Shift+K to switch anywhere",
  "chimera.connect.title": "Connect {{name}}",
  "chimera.connect.welcome": "Welcome to {{name}}",
  "chimera.connect.subtitle": "Connect your enterprise gateway to get started",
  "chimera.connect.gateway": "Gateway",
  "chimera.connect.managed": "Managed",
  "chimera.connect.tab.account": "Account",
  "chimera.connect.tab.key": "API key",
  "chimera.connect.username": "Account",
  "chimera.connect.username.placeholder": "Relay station username",
  "chimera.connect.password": "Password",
  "chimera.connect.showSecret": "Show",
  "chimera.connect.hideSecret": "Hide",
  "chimera.connect.signIn": "Sign in and sync keys",
  "chimera.connect.saveKey": "Save key",
  "chimera.connect.footnote": "Accounts and keys are managed by the relay station · all keys sync after sign-in",
  ...
  "chimera.models.empty": "Connect the relay station to load available models",
  "chimera.models.connect": "Connect relay station",
  "chimera.models.header.model": "Model",
  "chimera.models.header.protocol": "Protocol",
  "chimera.models.header.context": "Context",
  "chimera.models.header.default": "Default",
  "chimera.models.header.status": "Status",
  "chimera.models.protocol.openaiCompatible": "OpenAI compatible",
  "chimera.models.setDefault": "Set {{id}} as default model",
  "chimera.models.currentDefault": "Current default model",
  "chimera.models.setDefaultHint": "Set as default (new sessions prefer it)",
  "chimera.models.footnote": "Models are issued and configured by your administrator in the gateway console. Only enable / disable locally.",
  ...
  "ui.chimera.agent.build": "Build",
  "ui.chimera.agent.plan": "Plan",

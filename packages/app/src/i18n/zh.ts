...
export const dict = {
  ...
  "dialog.plugins.empty": "在 chimera.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (chimera.json) 中的 provider/model 名称",
  ...
  "session.review.filesChanged": "{{count}} 个更改",
  ...
  "chimera.nav.review": "代码审查",
  "chimera.nav.terminal": "终端",
  "chimera.nav.settings": "设置",
  "chimera.nav.account": "账户与密钥",
  "chimera.nav.sessionOnly": "{{label}}（会话内可用）",
  "chimera.command.switchKey.title": "切换密钥",
  "chimera.command.switchKey.description": "在中转站的多条密钥间切换",
  "chimera.status.key": "密钥 {{name}}",
  "chimera.status.key.label": "选择密钥：",
  "chimera.status.key.tooltip": "点击切换密钥（Ctrl+Shift+K）",
  "chimera.status.key.manage": "管理密钥…",
  "chimera.status.sessionCost": "会话 {{cost}}",
  "chimera.status.sessionCost.tooltip": "当前会话累计费用",
  "chimera.status.context": "上下文",
  "chimera.status.context.tooltip": "上下文 {{used}} / {{limit}} tokens",
  "chimera.status.gateway.tooltip": "网关连接",
  "chimera.status.changes": "· {{count}} 处更改",
  "chimera.status.changes.tooltip": "本会话变更",
  "chimera.session.turnRail.label": "会话定位",
  "chimera.session.turnRail.turn": "第 {{n}} 轮",
  "chimera.keys.title": "密钥",
  "chimera.keys.description": "中转站账号下的接入密钥，可随时切换",
  "chimera.keys.add": "添加密钥",
  "chimera.keys.header.name": "名称",
  "chimera.keys.header.key": "密钥",
  "chimera.keys.header.actions": "操作",
  "chimera.keys.name.placeholder": "如：个人密钥",
  "chimera.keys.key.placeholder": "sk-... / chm-...",
  "chimera.keys.save": "保存并使用",
  "chimera.keys.switch": "切换",
  "chimera.keys.delete": "删除",
  "chimera.keys.deleteNamed": "删除 {{name}}",
  "chimera.keys.inUse": "使用中",
  "chimera.keys.current": "当前",
  "chimera.keys.copy": "复制密钥",
  "chimera.keys.copied": "密钥已复制",
  "chimera.keys.rename": "重命名",
  "chimera.keys.renameNamed": "重命名 {{name}}",
  "chimera.keys.renamed": "已重命名为 {{name}}",
  "chimera.keys.deleteTitle": "删除密钥",
  "chimera.keys.deleteConfirm": "确定删除「{{name}}」？仅从本机移除。",
  "chimera.keys.deleteConfirmActive": "「{{name}}」正在使用。删除后将切换到「{{next}}」。",
  "chimera.keys.deleteConfirmLast": "「{{name}}」是当前唯一密钥。删除后将断开网关，直到你添加新密钥。",
  "chimera.keys.deleted": "密钥已删除",
  "chimera.keys.actions": "密钥操作",
  "chimera.keys.empty": "还没有登记密钥 · 通过设备授权获取，或手动粘贴已有密钥",
  "chimera.keys.disconnected": "未连接",
  "chimera.keys.chooseMethod": "通过设备授权获取密钥，或手动粘贴已有密钥",
  "chimera.keys.connected": "已连接",
  "chimera.keys.signedIn": "已登录",
  "chimera.keys.notSignedIn": "未登录",
  "chimera.keys.signOut": "退出登录",
  "chimera.keys.signedOut": "已退出登录",
  "chimera.keys.switched": "已切换到 {{name}}",
  "chimera.keys.switchFailed": "切换失败，请检查网关可用性",
  "chimera.keys.enterKey": "请输入密钥",
  "chimera.keys.defaultName": "密钥 {{index}}",
  "chimera.keys.footnote": "同一中转站可保存多条密钥 · 任意界面 Ctrl+Shift+K 快速切换",
  "chimera.connect.title": "连接 {{name}}",
  "chimera.connect.welcome": "欢迎使用 {{name}}",
  "chimera.connect.subtitle": "连接企业网关后开始使用",
  "chimera.connect.gateway": "网关地址",
  "chimera.connect.managed": "管理员预置",
  "chimera.connect.tab.account": "账号密码",
  "chimera.connect.tab.key": "API 密钥",
  "chimera.connect.username": "账号",
  "chimera.connect.username.placeholder": "中转站用户名",
  "chimera.connect.password": "密码",
  "chimera.connect.showSecret": "显示",
  "chimera.connect.hideSecret": "隐藏",
  "chimera.connect.signIn": "登录并同步密钥",
  "chimera.connect.saveKey": "保存密钥",
  "chimera.connect.footnote": "账号与密钥由中转站统一管理 · 登录后自动同步该账号下全部密钥",
  ...
  "chimera.connect.tab.device": "设备授权",
  "chimera.connect.device.intro": "账号密码不经过桌面端。开始授权后在浏览器完成登录，桌面端将自动继续。",
  "chimera.connect.device.start": "开始授权",
  "chimera.connect.device.codeLabel": "设备码",
  "chimera.connect.device.waiting": "已打开浏览器确认页，完成登录后此处自动继续",
  "chimera.connect.device.openManually": "重新打开确认页",
  "chimera.connect.device.cancel": "取消",
  "chimera.connect.device.syncing": "已授权，正在同步密钥…",
  "chimera.connect.device.expired": "授权超时，请重新发起",
  "chimera.connect.device.failed": "授权失败，请检查网关可用性",
  "chimera.connect.device.desktopOnly": "设备授权需要在桌面端使用，此处请改用 API 密钥方式",
  ...
  "chimera.models.empty": "连接中转站后才会同步可用模型",
  "chimera.models.connect": "连接中转站",
  "chimera.models.header.model": "模型",
  "chimera.models.header.protocol": "协议",
  "chimera.models.header.context": "上下文",
  "chimera.models.header.default": "默认",
  "chimera.models.header.status": "状态",
  "chimera.models.protocol.openaiCompatible": "OpenAI 兼容",
  "chimera.models.setDefault": "设为默认模型 {{id}}",
  "chimera.models.currentDefault": "当前默认模型",
  "chimera.models.setDefaultHint": "设为默认（新会话优先使用）",
  "chimera.models.footnote": "模型由管理员在网关控制台签发与配置。本地仅可启用 / 停用。",

...
import chimeraThemeJson from "./themes/chimera.json"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  if (meta) meta.setAttribute("content", isDark ? "#0C100F" : "#F4F6F4")
}

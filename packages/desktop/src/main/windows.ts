...
import chimeraThemeJson from "../../../ui/src/theme/themes/chimera.json"
...
const chimeraTheme = chimeraThemeJson as DesktopTheme
const chimeraBackground = {
  light: resolveThemeVariant(chimeraTheme.light, false)["background-base"],
  dark: resolveThemeVariant(chimeraTheme.dark, true)["background-base"],
}

export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Chimera",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Chimera has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'chimera' command.",
